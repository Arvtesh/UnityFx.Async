...
namespace UnityFx.Async
{
	...
	/// tt
	/// </summary>
	public sealed class AsyncResultController<T> : AsyncResult<T>, IAsyncCompletionSource<T>
	{
		#region interface

		/// <summary>
		/// Initializes a new instance of the <see cref="AsyncResultController{T}"/> class.
		/// </summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="AsyncResultController{T}"/> class that is faulted.
		/// </summary>
